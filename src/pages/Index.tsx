              ...
              <CardHeader>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      <p className="mb-3">Создание коллажа через нейросеть Dzinе. 

Midjourney для дизайнера интерьера - как приручить дракона.</p>
                      
                      <p className="mb-3">Действенный метод работы без запоминания промтов. Как получить от нейросети нужный результат. 

Делаем дополнительные ракурсы.</p>
                      
                      <p>Замена текстуры, создание бесшовных текстур для визуализаций. 

Создание ультрареалистичных видео по вашим визуализациям для клиентов и ваших соц.сетей</p>
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
              ...
              <CardHeader>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription>Нейросеть PromeAI как дополнительный инструмент
Как улучшить качество изображения через ИИ</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
